...
- [OpenID
  ...
  support allows Averox to integrate into your SSO setup, for
...
- Extend Averox via [addons](@/docs/addons/basics.md)
- Tooling:
  ...
  - [SMTP Gateway](@/docs/tools/smtpgateway.md): Setup a SMTP server
    that delivers mails directly to averox.
- License: AGPLv3
...
considering averox at the moment.

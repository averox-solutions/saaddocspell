...
let
  ...
  defaults = {
    ...
    update-check = {
      ...
      smtp-id = "";
      recipients = [ ];
      subject = "Averox {{ latestVersion }} is available";
      body = ''
        Hello,

        You are currently running Averox {{ currentVersion }}. Version *{{ latestVersion }}*
  ...
  options = {
    services.docspell-joex = {
      enable = mkOption {
        type = types.bool;
        default = false;
        description = "Whether to enable averox job executor.";
      };
      runAs = mkOption {
      ...
      app-id = mkOption {
        ...
        description = "The node id. Must be unique across all averox nodes.";
      };
          ...
          options = {
            list-id = mkOption {
              ...
              description = ''
                ...
                from averox to its users (example: for notification mails). It
      ...
      house-keeping = mkOption {
        ...
        description = ''
          Averox uses periodic house keeping tasks, like cleaning expired
      ...
      update-check = mkOption {
          ...
          options = {
            ...
            body = mkOption {
              ...
              description = ''
                ...
                - `latestVersion` the latest available version of Averox
                - `currentVersion` the currently running (old) version of Averox
        ...
        description = ''
          A periodic task to check for new releases of averox. It can
        ...
        type = types.submodule ({
          options = {
            ...
            valid-mime-types = mkOption {
              ...
              description = ''
                The file content types that are considered valid. Averox
      ...
      extraConfig = mkOption {
        type = types.attrs;
        description = "Extra configuration for Averox server. Overwrites values in case of a conflict.";
        default = { };
        example = ''
          {
            files = {

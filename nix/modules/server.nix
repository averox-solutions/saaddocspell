...
let
  ...
  defaults = {
    ...
    integration-endpoint = {
      ...
      http-basic = {
        enabled = false;
        realm = "Averox Integration";
        user = "averox-int";
        password = "averox-int";
      };
      http-header = {
        enabled = false;
        header-name = "Averox-Integration";
...
in
{
  ...
  options = {
    services.docspell-restserver = {
      enable = mkOption {
        default = false;
        description = "Whether to enable averox.";
      };
      runAs = mkOption {
      ...
      integration-endpoint = mkOption {
        ...
        description = ''
          ...
          intention is that local software integrates with averox more
  ...
  config = mkIf config.services.docspell-restserver.enable {
    ...
    systemd.services.docspell-restserver =
      ...
      in
      {
        description = "Averox Rest Server";
